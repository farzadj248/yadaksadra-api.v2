...
<head>
    ...
    <title>فاکتور خرید | {{ $data['order']['order_code'] }}</title>
    <style>
        .clearfix:after {
            content: "";
            display: table;
            ...
            <tbody style="padding:0;margin:0">
                <tr>
                    <td style="background: #fff;width:35%;padding:8px;" class="p-0">
                        <div id="logo">
                            <img src="https://api.yadaksadra.com//logo.png" width="75">
                        </div>
                    </td>
                ...
                <tr>
                    <td style="background: #fff;width:50%;">
                        <div id="client">
                            ...
                            <div class="address">نشانی: اصفهان،پوریای ولی،کوچه ژاله 35،خیابان کاوه،تجار و اداری
                                ماهنوش،پلاک 449،طبقه 2</div>
                            <div class="postal-code">کد پستی: 8148998763</div>
            ...
            <tbody>
                @foreach ( $data['orderItems'] as $item)
                    <tr>
                        ...
                        <td class="total">{{ $item['saved_price'] * $item['quantity']}}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td style="background: #fff; padding:8px;">
                        <p style="margin-bottom: 20px">{{ $data['order']['gateway_pay'] }}</p>
                    </td>
                </tr>
            </tbody>
        </table>
